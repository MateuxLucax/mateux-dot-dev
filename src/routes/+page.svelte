...
<section>
  <ul class="list-none gap-2 flex flex-col">
    <li><Prompt /> cd <span class="text-yellow-500">~/About</span></li>
    <li><Prompt path="/About" /> <span class="text-blue-500">cat</span> <span class="text-pink-400">README.md</span></li>
    <li>
    ...
    <li><Prompt /> cd <span class="text-yellow-500"> ~/Contacts</span></li>
    {#each commands as cmd}
      <li>
        <Prompt path="/Contacts" />
        curl <span class="text-green-500">-I</span>
        <a href="{cmd.url}" target="_blank" class="p-2 rounded text-pink-400 hover:bg-gray-200 active:bg-gray-300 focus:bg-gray-300">
          {cmd.url}
        </a>
      </li>
